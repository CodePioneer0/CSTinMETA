...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      loginWithToken(res.data.token, res.data.anonymousId);
  ...
  return (
    <div className="min-h-screen bg-dark-950 noise-bg relative overflow-hidden flex">
      <div className="orb-purple-xl top-[-100px] left-[-80px]" style={{ position: 'absolute' }} />
      ...
      <div className="w-[45%] hidden lg:flex flex-col items-center justify-center relative z-10 border-r border-white/5 bg-dark-900/20">
        ...
        >
          <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-royal-500 to-sugar-500 flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-royal-500/30 animate-float">
          ...
          <p className="text-dark-400 text-lg max-w-xs mx-auto">
            AI-powered sugar tracking for a healthier you
          </p>
        </motion.div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 lg:px-12 relative z-10">
        ...
        >
          ...
          <p className="text-sm text-dark-400 mt-8">
            ...
            <Link to="/welcome" className="text-royal-400 hover:text-royal-300 font-medium">
              Get Started
            </Link>
          </p>
        </motion.div>
